...
export default class SteadyFlowLayer {
    ...
    async init() {
        ...
        this.voronoiPipeline = scr.renderPipeline({
            ...
            shader: { module: scr.shaderLoader.load('Shader (Flow Voronoi)', '/scratchSomething/terrain_flow/shaders/flowVoronoi_mask.wgsl') },
        })
        ...
        this.simulationPipeline = scr.computePipeline({
            ...
            shader: { module: scr.shaderLoader.load('Shader (Particle Simulation)', '/scratchSomething/terrain_flow/shaders/simulation.compute.wgsl') },
        ...
        this.trajectoryPipeline = scr.renderPipeline({
            ...
            shader: { module: scr.shaderLoader.load('Shader (Background Trajectory)', '/scratchSomething/terrain_flow/shaders/trajectory.wgsl') },
        ...
        this.segmentPipeline = scr.renderPipeline({
            ...
            shader: { module: scr.shaderLoader.load('Shader (Segment)', '/scratchSomething/terrain_flow/shaders/segment.wgsl') },
            colorTargetStates: [{ blend: scr.PremultipliedBlending }],
        ...
        this.layerPipeline = scr.renderPipeline({
            ...
            shader: { module: scr.shaderLoader.load('Shader (Flow Layer Rendering)', '/scratchSomething/terrain_flow/shaders/flowLayer.wgsl') },
            primitive: { topology: 'triangle-strip' },
        ...
        this.showPipeline = scr.renderPipeline({
            ...
            shader: { module: scr.shaderLoader.load('Shader (Flow Show)', '/scratchSomething/terrain_flow/shaders/flowShow.wgsl') },
            primitive: { topology: 'triangle-strip' },
            colorTargetStates: [{ blend: scr.NormalBlending }],
        })
        ...
        this.arrowPipeline = scr.renderPipeline({
            ...
            shader: { module: scr.shaderLoader.load('Shader (Flow Show)', '/scratchSomething/terrain_flow/shaders/arrow.wgsl') },
            primitive: { topology: 'triangle-strip' },
            colorTargetStates: [{ blend: scr.NormalBlending }],
        })
