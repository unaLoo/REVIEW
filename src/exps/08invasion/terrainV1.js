...
import sourceCode1 from './shader/V1_render2fbo.glsl'
import sourceCode2 from './shader/V1_contour.glsl'
...
function createCanvasSizeTexture(gl, type) {
    ...
    if (type === 'RGBA8') {
        ...
        gl.texImage2D(gl.TEXTURE_2D, 0, gl.R32F, gl.canvas.width, gl.canvas.height, 0, gl.RED, gl.FLOAT, null);
    }
    return texture;
}
