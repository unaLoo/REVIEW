...
export function main() {
    ...
    gui.add(settings, 'cameraX', -10, 10).onChange(render);
    gui.add(settings, 'cameraY', 1, 20).onChange(render);
    gui.add(settings, 'posX', -10, 10).onChange(render);
    gui.add(settings, 'posY', 1, 20).onChange(render);
    gui.add(settings, 'posZ', 1, 20).onChange(render);
    gui.add(settings, 'targetX', -10, 10).onChange(render);
    gui.add(settings, 'targetY', 0, 20).onChange(render);
    gui.add(settings, 'targetZ', -10, 20).onChange(render);
    gui.add(settings, 'projWidth', 0, 2).onChange(render);
    gui.add(settings, 'projHeight', 0, 2).onChange(render);
    gui.add(settings, 'perspective').onChange(render);
    gui.add(settings, 'fieldOfView', 1, 179).onChange(render);
